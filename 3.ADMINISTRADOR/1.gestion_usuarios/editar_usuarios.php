...
<body>
    ...
    <div class="d-flex justify-content-center container-fluid border-success mt-5">
        ...
        <div class="col-9 border border-success">
                    ...
                    $sql = "SELECT * FROM usuarios WHERE numero_doc = $numero_doc";
                    $result = mysqli_query($conexion, $sql);
                    while ($mostrar = mysqli_fetch_array($result)) {
                    ?>
                        <tr>
                            <form action="editar_usuarios_proceso.php" method="POST">
                                <input type="hidden" value="<?php echo $mostrar['numero_doc']?>" name="txtnumero_doc">
                                <input type="hidden" value="<?php echo $mostrar['tipo_doc']?>" name="txttipo_doc">
                                <input type="text" value="<?php echo $mostrar['nombre']?>" name="txtnombre">
                                <input type="text" value="<?php echo $mostrar['apellidos']?>" name="txtapellidos">
                                <input type="text" value="<?php echo $mostrar['direccion']?>" name="txtdireccion">
                                <input type="text" value="<?php echo $mostrar['telefono']?>" name="txttelefono">
                                <input type="text" value="<?php echo $mostrar['fecha_nacimiento']?>" name="txtfecha_nacimiento">
                                ...
                                <input type="text" value="<?php echo $mostrar['contraseña_confirmada']?>" name="txtcontraseña_confirmada">
