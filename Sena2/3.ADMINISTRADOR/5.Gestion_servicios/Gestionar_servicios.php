    ...
    <div  class="d-flex justify-content-center container-fluid border-success mt-5">
        <div  class="col-3">
            <div class="col-12">
                <div style="margin-top: 115px;" class="d-flex align-items-center justify-content-center h-100 ">
                    <a  style="width:250px" href="/Sena2/3.ADMINISTRADOR/2.Gestion_Categorias/Gestionar_categorias.php" class="btn btn-success">Ir a Gestion de categorias</a>
                </div>
            </div>
            ...
            <div class="col-12 mt-3">
                <div class="d-flex align-items-center justify-content-center h-100">
                    <a style="width:250px;" href="/Sena2/3.ADMINISTRADOR/1.gestion_usuarios/Gestionar_usuarios.php" class="btn btn-success">Ir a Gestionar Usuarios</a>
                </div>
            </div>
        </div>
        <div  class="col-9  ">
        ...
        <!-- CRUD de Usuarios -->
            <div class="container mt-4">
                <h2 style="color: green;" class="text-center">Gestion de servicios</h2>
                <a style="width:250px;" href="usuarios_crear.php" class="btn btn-success">Crear Nuevo servicio</a>
                ...
                <table  class="table table-bordered table-striped mt-2 table-responsive">
                    <thead>
                        <tr style="background-color: #28A745;color: #FFFF00;">
                            <th >Id</th>
                            <th >Tipo servicio</th>
                            <th >caracteristicas_servicio</th>
                            <th >Acciones</th>
                ...
                ?>
                    <thead>
                        <tr>
                            ...
                            <th style="background-color: #EAEDED;"><?php echo $mostrar['tipo_servicio']?></th>
                            <th style="background-color: #EAEDED;"><?php echo $mostrar['caracteristicas_servicio']?></th>
                          

                            
                          
                            <td>
                                <a  style="width: 100px;" class="btn btn-success"href="editar_servicio.php?id=<?php echo $mostrar['id'] ?>">Editar</a>
