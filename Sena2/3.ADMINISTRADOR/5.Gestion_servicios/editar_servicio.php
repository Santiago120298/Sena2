...
<body>
    ...
    <div class="d-flex justify-content-center container-fluid border-success mt-5">
        ...
        <div class="col-9 border border-success">
                    ...
                    ?>
                        <tr>
                            <form action="editar_servicio_proceso.php" method="POST">
                                <input type="hidden" value="<?php echo $mostrar['id']?>" name="txtid">
                                <input type="text" value="<?php echo $mostrar['tipo_servicio']?>" name="txttipo_servicio">
                                <input type="text" value="<?php echo $mostrar['caracteristicas_servicio']?>" name="txtcaracteristicas_servicio">
